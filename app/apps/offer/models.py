...
class Offer(CoreModel):
    barcode_no = models.CharField(max_length=128, null=True, blank=True,
    ...
    koli_adedi = models.IntegerField(null=True, blank=True,
                                     verbose_name="Koli Adedi")
    koli_sayisi = models.IntegerField(null=True, blank=True,
                                      verbose_name="Koli Sayısı")
