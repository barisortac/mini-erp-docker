...
class ProductSize(CoreModel):
    ...
    sarim_adet_mt = models.CharField(max_length=128, verbose_name="Sarım Adet/Mt")
...
class Product(CoreModel):
    ...
    description = models.CharField(max_length=512, null=True, blank=True,verbose_name='Stok Açıklaması')
    ...
    # 24
    package_unit = models.FloatField(default=1, verbose_name="Ambalaj Birimi", validators = [MinValueValidator(0.0)]) # 10'lu ambalaj katları vs.
