...
urlpatterns = [
    ...
    path('product_type/list/', ProductTypeListJson.as_view(), name="list-product-type-json"),
    path('product_type/create/', ProductTypeCreateView.as_view(), name='create-product-type'),
    path('product_type/update/<int:pk>', ProductTypeUpdateView.as_view(), name='update-product-type'),
    path('product_type/read/<int:pk>', ProductTypeReadView.as_view(), name='read-product-type'),
    path('product_type/delete/<int:pk>', ProductTypeDeleteView.as_view(), name='delete-product-type')
]